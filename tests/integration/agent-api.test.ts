...
withApiServer('Agent API Integration Tests', () => {
  ...
  describe('Agent Execution API', () => {
    ...
    test(
      'should execute task with sessionId',
      async () => {
    ...
    test(
      'should execute task with availableSkills',
      async () => {
        const response = await fetch(`${API_BASE_URL}/agent/execute`, {
          method: 'POST',
          headers: {
    ...
    test(
      'should reject invalid request (missing task)',
      async () => {
        const response = await fetch(`${API_BASE_URL}/agent/execute`, {
          method: 'POST',
          headers: {
  ...
  describe('Agent Execution Flow', () => {
    test(
      'should complete full workflow: API → Event → Agent → Result',
      async () => {
  ...
  describe('Authentication', () => {
    test(
      'should reject requests without valid API key (if auth enabled)',
      async () => {
        const response = await fetch(`${API_BASE_URL}/agent/execute`, {
          method: 'POST',
          headers: {
...
withApiKey('Agent Direct Execution Tests', () => {
  ...
  test(
    'should execute simple task directly',
    async () => {
