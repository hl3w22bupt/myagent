        ...
        if exit_code == 0:
            ...
            try:
                ...
                if OUTPUT_BUILDER_AVAILABLE:
                    ...
                    # If workspace has files, add output_files to result
                    # task-result-handler will process output_files when result_type is 'text'
                    if output_files:
                ...
                if OUTPUT_BUILDER_AVAILABLE:
                    ...
                    # If workspace has files, add output_files at top level
                    if output_files:
                        result = builder.build()
                        result['output_files'] = output_files
                        write_structured_output(result, session_id)
